...
public final class DatabaseModule_ProvideDatabaseFactory implements Factory<PostsDataBase> {
  ...
  public static PostsDataBase provideDatabase(Application app) {
